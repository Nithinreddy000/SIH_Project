...
//Voucher Num
// Define API endpoints using the retrieved voucherNumID
export const GET_VOUCHER_NUM_DATA = `/api/InfinityX/VoucherNumData`;
export const GET_VOUCHER_IMAGES_NUM_DATA = `/api/InfinityX/VoucherNumCameraCaptures`;
// File Manager
// Folder
